...
const useObtenerPopulares = () => {
    ...
    try { // Promesa
        ...
        setPopulares(data.results)                  // Establece el estado "peliculas" con los resultados obtenidos de la API
    ...
    return populares // retornamos la data de la respuesta obtenida
}

export default useObtenerPopulares;